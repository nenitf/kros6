...
```
## Sugestões reconhecidamente necessárias

<!-- - Popular csv com todos os [krosmasters](https://krosarchive.es/PT/seasons) -->
- Aumentar a lista de krosmasters nas [`fixtures`](/test/backend/fixtures/krosmasters.dart)
- Aumentar os cenários de testes com adicionando [`dataProviders`](/test/backend/create_random_valid_team_test.dart)
